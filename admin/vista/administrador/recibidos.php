        ...
        <header>
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><a href="recibidos.php">Volver</a><li>
        ...
        <div class="containerMensajerR">
            ...
            <table id="tabla" style="width:100%">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM mensaje   ORDER BY mail_fecha DESC " ;
                    $result = $conn->query($sql);
                   
                    $sql2="SELECT count(*) FROM mensaje  ORDER BY mail_fecha DESC " ;
                    $res=$conn->query($sql2);
                    $num_rows=$res;
                   if ($num_rows > 0) {
                    ...
                    echo " <td>" .'<a href="../../controladores/administrador/eliminarMail.php?mail_codigo='.$row["mail_codigo"].'&delete=' . true .'" > Eliminar </a>'. "</td>";
                    echo "</tr>";
                   }
                   } else {
                   echo "<tr>";
